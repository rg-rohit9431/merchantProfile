    ...
    return (
        <div
            ...
            <div className='w-full relative'>
                <img src={burger} alt="image-menu" className='w-full aspect-auto object-contain' />
                ...
                <p className='w-fit px-[.5rem] rounded-xl bg-[#FFD628] font-[500] sm:text-[1.2rem] absolute bottom-[.3rem] sm:bottom-[1rem] right-[.3rem] sm:right-[1rem] '>₹ 399</p>
            </div>
            <div>
